...
export default function Header() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-500 
    to-indigo-200"
      id="header"
    >
      <div className="flex flex-col items-center justify-center md:flex-row-reverse md:w-10/12 md:justify-between">
        ...
        <div className="font-dosis w-full md:w-3/5 text-center md:text-left ">
          ...
          <ScrollLink to="aboutme" smooth={true}>
            <button
              className={` animate-bounce bg-purple-600 px-10 py-3 text-lg uppercase text-white rounded-lg mt-10 hover:bg-purple-900 transform  ${
                animated ? "translate-y-0" : styleTranslate
              } ${transition(3500)}`}
            >

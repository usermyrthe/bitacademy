export default {
  ...
  header: {
    img: process.env.PUBLIC_URL + "/assets/computer.jfif",
    imgPlaceholder:
    ...
    text: ["Hi!", "I'm Maarten.", "I am a "],
    typical: ["full stack web developer. 🖥", 2000],
    btnText: "Get to know me",
  },
  aboutme: {
    title: "",
    img: process.env.PUBLIC_URL + "/assets/myrthe1.png",
    imgPlaceholder:
    ...
    desc:
      "Hello! My name is Maarten. I have started coding recently and I can proudly welcome you to my first website! More information coming up soon!! In the mean time check me out on social media!",
  },
